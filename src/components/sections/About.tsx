                ...
                <div className="grid md:grid-cols-2 gap-12 items-start">
                    ...
                    <div className="space-y-6">
                        ...
                        <p className="text-muted-foreground leading-relaxed">
                            I am a passionate Full-Stack Engineer specializing in system architecture,
                            database management, and API design. My journey in technology is driven by
                            a desire to build scalable, efficient, and secure digital solutions.
                        </p>
                        <p className="text-muted-foreground leading-relaxed">
                            Beyond code, I am a musician. This artistic background influences my
                            engineering approach—bringing creativity, rhythm, and harmony to the
                            systems I design. I believe that great software, like great music,
                            requires structure, flow, and attention to detail.
                        </p>
                        ...
                        <div>
                            ...
                            <div className="relative border-l-2 border-border ml-3 pl-8 space-y-8">
                                <div className="relative">
                                    ...
                                    <p className="text-primary text-sm mb-1">GIS Training Center, Bangangté</p>
                                    <p className="text-muted-foreground text-sm">
                                        Intensive training in modern web development, system design, and database management.
                                    </p>
                                </div>
                                <div className="relative">
                                    <div className="absolute -left-[39px] w-5 h-5 rounded-full border-4 border-background bg-primary"></div>
                                    ...
                                    <p className="text-muted-foreground text-sm">
                                        Mathematics, Further Mathematics, Chemistry, Computer Science, and Physics.
                                    </p>
                                </div>
                            </div>
                        </div>
