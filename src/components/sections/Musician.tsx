      ...
      <div className="container px-4 md:px-6 relative z-10">
        <div className="flex flex-col items-center text-center mb-12">
          ...
          <p className="text-muted-foreground mt-8 max-w-2xl text-lg leading-relaxed">
            Beyond the world of code and architecture, I am deeply passionate
            about music. I have dedicated time to learning and practicing music,
            which serves as both a creative outlet and a source of inspiration
