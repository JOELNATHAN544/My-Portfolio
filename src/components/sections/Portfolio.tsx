        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6">
            ...
            <p className="text-muted-foreground leading-relaxed">
              A robust web application designed to simplify link management.
              Users can upload, store, and organize URL links, share them
              publicly, and browse a curated feed of links submitted by the
              community.
            </p>
