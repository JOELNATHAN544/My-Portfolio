      ...
      <div className="container relative z-10 grid md:grid-cols-2 gap-12 items-center">
        ...
        <div className="space-y-6 text-center md:text-left animate-in slide-in-from-left duration-700">
          ...
          <p className="text-lg md:text-xl text-muted-foreground max-w-lg mx-auto md:mx-0">
            Building scalable systems, designing efficient databases, and
            crafting high-performance APIs. Blending technical depth with
            artistic creativity.
          </p>
        ...
        <div className="flex justify-center md:justify-end animate-in slide-in-from-right duration-700 delay-200">
          <div className="relative w-72 h-72 md:w-96 md:h-96">
            <div
              className="absolute inset-0 border-2 border-primary/20 rounded-full animate-spin-slow"
              style={{ animationDuration: "15s" }}
            ></div>
            <div
              className="absolute inset-4 border-2 border-accent/20 rounded-full animate-spin-reverse-slow"
