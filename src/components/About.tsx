  ...
  const skillsOverview = [
    {
      category: "Backend",
      description:
        "Designing robust, scalable server-side applications with clean architecture",
    },
    {
      category: "Databases",
      description:
        "Efficient data modeling and optimization for performance and reliability",
    },
    {
      category: "DevOps",
      description:
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-16 animate-fade-in">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Full-stack engineer with a passion for building robust systems and
              a creative soul
            </p>
          </div>
            ...
            <div className="space-y-8">
              <Card className="p-8 shadow-soft hover:shadow-glow transition-all duration-300 animate-fade-in">
                ...
                <div className="space-y-4 text-muted-foreground">
                  <p>
                    I'm a full-stack engineer with a strong foundation in system
                    architecture, database design, and API development.
                  </p>
                  <p>
                    My artistic background as a musician helps me bring
                    creativity and balance into problem-solving and user
                    experience.
                  </p>
                </div>
              </Card>
              ...
              <Card className="p-8 shadow-soft hover:shadow-glow transition-all duration-300 animate-fade-in">
                ...
                <div className="space-y-6">
                  {education.map((item, index) => (
                    <div
                      key={index}
                      className="relative pl-10 pb-6 border-l-2 border-primary/20 last:border-0 last:pb-0"
                    >
            ...
            <Card className="p-8 bg-primary/5 border-primary/20">
              <div className="flex flex-col items-center">
                ...
                <p className="text-lg text-muted-foreground italic">
                  "My journey in technology is deeply intertwined with my love
                  for music. Both require creativity, precision, and structure."
                </p>
              </div>
            </Card>
          </div>
