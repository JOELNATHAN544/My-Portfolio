  ...
  const projects = [
    {
      title: "Linksphere",
      description:
        "A comprehensive web application that enables users to upload and store URL links, share them publicly with the community, and discover links submitted by others. Features a clean, intuitive interface with robust backend architecture.",
    ...
    },
    {
      ...
      description:
        "Designed and implemented a scalable microservices architecture for a high-traffic e-commerce platform, reducing response times by 40% and improving system reliability.",
      image:
    ...
    },
    {
      ...
      description:
        "Optimized database queries and schema design for a financial application, resulting in 60% faster query performance and reduced server costs by 35%.",
      image:
    ...
    },
    {
      ...
      description:
        "Developed a high-performance RESTful API with rate limiting, authentication, and comprehensive documentation using OpenAPI/Swagger.",
      image:
    ...
    },
    {
      ...
      description:
        "Trained and deployed a machine learning model using TensorFlow and scikit-learn to predict customer churn, resulting in a 25% reduction in churn rate.",
      image:
        "https://images.unsplash.com/photo-1552664730-d307ca884978?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1470&q=80",
      technologies: [
        "Python",
    ...
    },
    {
      title: "Web Scraping",
      description:
        "Developed a web scraping tool using Python and BeautifulSoup to extract data from e-commerce websites, resulting in a 30% increase in sales.",
      image:
        "https://images.unsplash.com/photo-1551288049-bebda4e38f71?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1470&q=80",
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-12 animate-fade-in">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto mb-8">
              Showcasing real-world applications and solutions I've built with
              modern technologies
            </p>
